...
Why might you expect to see chloroplast or mitochondrial sequences in  
a bacterial dataset? 
```
...
Can you think of situations where singletons and doubletons should specifically  
be kept as part of the dataset?
```
...
Based on the rarefaction curve, what do you think might be best - proceeding  
as is or rarefying the data to even depth?
```
...
```
Based on the plot, what would you anticipate - are the time points likely  
to differ?
...
```
Why might we want to use CLR transformation here, instead of % relative  
abundances?
```
...
Does it look like any difference between groups could be due to  
a "location effect", "dispersion effect" or both? 
