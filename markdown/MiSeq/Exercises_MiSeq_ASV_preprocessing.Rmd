...
As input, select the files `dada_forward.Rda`, `dada_reverse.Rda` and `filtered.fastqs.tar` and run the tool `Combine paired reads to contigs with  DADA2`.  To select multiple files, hold down the control key (in Windows/Linux) or the command 
key (Mac) and then click the files.
